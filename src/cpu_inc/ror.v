...
`wire_8 ror_var; assign ror_var = {`C, wire_data_byte_0[7:1]};
wire ror_var_n; assign ror_var_n = ror_var[7];
wire ror_var_z; assign ror_var_z = (ror_var == `ZERO_8) ? 1 : 0;
wire ror_var_c; assign ror_var_c = wire_data_byte_0[0];

`wire_32 ror_evar; assign ror_evar = {`eC, wire_data_word[30:0]};
wire ror_evar_n; assign ror_evar_n = ror_evar[31];
wire ror_evar_z; assign ror_evar_z = (ror_evar == `ZERO_32) ? 1 : 0;
wire ror_evar_c; assign ror_evar_c = wire_data_word[0];
