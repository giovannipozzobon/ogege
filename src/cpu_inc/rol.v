...
`wire_8 rol_var; assign rol_var = {i_bus_data[6:0], `C};
wire rol_var_n; assign rol_var_n = rol_var[7];
wire rol_var_z; assign rol_var_z = (rol_var == `ZERO_8) ? 1 : 0;
wire rol_var_c; assign rol_var_c = i_bus_data[7];

`wire_32 rol_evar; assign rol_evar = {reg_data_word[30:0], `eC};
wire rol_evar_n; assign rol_evar_n = rol_evar[31];
wire rol_evar_z; assign rol_evar_z = (rol_evar == `ZERO_32) ? 1 : 0;
wire rol_evar_c; assign rol_evar_c = reg_data_word[31];
